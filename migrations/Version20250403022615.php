 ...
 */
final class Version20250403022615 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE estudiante (id INT AUTO_INCREMENT NOT NULL, nacionalidad_id INT DEFAULT NULL, uniforme_talla_id INT DEFAULT NULL, identificacion VARCHAR(255) NOT NULL, apellidos VARCHAR(255) NOT NULL, nombres VARCHAR(255) NOT NULL, sexo VARCHAR(255) NOT NULL, fecha_nacimiento DATE NOT NULL, direccion LONGTEXT DEFAULT NULL, telefono VARCHAR(255) DEFAULT NULL, correo VARCHAR(255) DEFAULT NULL, tiene_discapacidad TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_3B3F3FAD84291D2B (identificacion), INDEX IDX_3B3F3FADAB8DC0F8 (nacionalidad_id), INDEX IDX_3B3F3FADDC47B5C3 (uniforme_talla_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE expediente (id INT AUTO_INCREMENT NOT NULL, estudiante_id INT NOT NULL, fecha_ingreso DATETIME DEFAULT NULL, esta_completo TINYINT(1) NOT NULL, esta_retirado TINYINT(1) NOT NULL, fecha_retiro DATETIME DEFAULT NULL, observacion VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_D59CA41359590C39 (estudiante_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE expediente_requisito (expediente_id INT NOT NULL, requisito_id INT NOT NULL, INDEX IDX_34CEF95F4BF37E4E (expediente_id), INDEX IDX_34CEF95FFA50198E (requisito_id), PRIMARY KEY(expediente_id, requisito_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE matricula (id INT AUTO_INCREMENT NOT NULL, estudiante_id INT NOT NULL, jornada_id INT NOT NULL, modalidad_id INT NOT NULL, paralelo_id INT NOT NULL, grado_escolar_id INT NOT NULL, periodo_lectivo_id INT NOT NULL, fecha DATE DEFAULT NULL, esta_activa TINYINT(1) NOT NULL, fecha_inactivacion DATETIME DEFAULT NULL, observacion LONGTEXT DEFAULT NULL, INDEX IDX_15DF188559590C39 (estudiante_id), INDEX IDX_15DF188526E992D9 (jornada_id), INDEX IDX_15DF18851E092B9F (modalidad_id), INDEX IDX_15DF1885DB3C1E64 (paralelo_id), INDEX IDX_15DF1885B6E91F0F (grado_escolar_id), INDEX IDX_15DF1885D871B602 (periodo_lectivo_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE periodo_lectivo (id INT AUTO_INCREMENT NOT NULL, descripcion VARCHAR(255) NOT NULL, fecha_inicio DATE NOT NULL, fecha_fin DATE NOT NULL, habilitado_para_matricula TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE representante (id INT AUTO_INCREMENT NOT NULL, identificacion VARCHAR(255) NOT NULL, apellidos VARCHAR(255) NOT NULL, nombres VARCHAR(255) NOT NULL, fecha_nacimiento DATE DEFAULT NULL, direccion LONGTEXT DEFAULT NULL, telefono VARCHAR(255) DEFAULT NULL, correo VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_DE2D59584291D2B (identificacion), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, avatar VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), UNIQUE INDEX UNIQ_IDENTIFIER_USERNAME (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE expediente_requisito');
